...
def test_a_selected_service_adds_a_line_and_its_price():
    ...
    # amg base+options is 6_200_000; the service is on top.
    assert q.total == 6_200_000 + 500_000
...
def test_multiple_services_stack():
    ...
    assert q.total == 6_200_000 + 400_000 + 150_000
...
def test_booking_recomputes_total_with_services(monkeypatch):
    ...
    assert res.status_code == 200
    assert res.json()["total"] == 6_200_000 + 500_000
