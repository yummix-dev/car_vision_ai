...
const MESSAGES = {
  ru: {
    ...
    // ── v2 redesign: overrides (later duplicate key wins) & additions ──
    "home.title": "Что примерим на вашу машину?",
    "home.lede": "Выберите зону — дальше одно фото и результат.",
    "home.showcase": "Наши работы",
    "upload.eg_ok": "верно",
    "upload.eg_bad": "слишком близко",
    "car.photo_title": "Ваше фото",
    "car.detected_by": "AI определил по фото",
    "car.wrong": "Не то",
    "car.match_hint": "{plural} подберём именно под эту машину.",
    "car.show": "Показать {plural}",
    "car.your_car": "Ваш автомобиль",
    "car.f_year": "Год",
    "config.cta_generate": "Примерить",
    "config.install_included": "Установка входит в цену",
    "result.add_to_cart": "В сборку",
    "cart.checkout": "К заявке",
    "cart.build_sub": "Установим за один визит.",
    "cart.other_zone": "Примерить другую зону",
    "cart.work": "Работа мастера",
    "cart.work_incl": "включена",
    "cart.payment": "Оплата",
    "cart.payment_val": "на месте · как удобно",
    "cart.positions_n": "{n} поз.",
    "request.hdr": "Заявка",
    "request.title": "Куда позвонить?",
    "request.lede": "Дату, оплату и детали мастер уточнит в разговоре — заполнять больше ничего не нужно.",
    "request.f_phone": "Телефон",
    "request.from_tg": "из вашего Telegram",
    "request.plus_more": "{first} и ещё {n}",
    "request.add_details": "Добавить дату и комментарий",
    "request.no_pay": "Ничего не платите сейчас",
    "showcase.title": "Наши работы",
    "success.title": "Заявка №{n} принята",
  ...
  uz: {
    ...
    // ── v2 redesign: overrides & additions ──
    "home.title": "Mashinangizga nimani primerka qilamiz?",
    "home.lede": "Zonani tanlang — keyin bitta surat va natija.",
    "home.showcase": "Bizning ishlar",
    "upload.eg_ok": "toʻgʻri",
    "upload.eg_bad": "juda yaqin",
    "car.photo_title": "Sizning suratingiz",
    "car.detected_by": "AI surat boʻyicha aniqladi",
    "car.wrong": "Notoʻgʻri",
    "car.match_hint": "{plural} aynan shu mashinaga tanlaymiz.",
    "car.show": "{plural} koʻrsatish",
    "car.your_car": "Sizning avtomobilingiz",
    "car.f_year": "Yil",
    "config.cta_generate": "Primerka qilish",
    "config.install_included": "Oʻrnatish narxga kiritilgan",
    "result.add_to_cart": "Yigʻmaga",
    "cart.checkout": "Arizaga",
    "cart.build_sub": "Bir tashrifda oʻrnatamiz.",
    "cart.other_zone": "Boshqa zonani primerka qilish",
    "cart.work": "Usta ishi",
    "cart.work_incl": "kiritilgan",
    "cart.payment": "Toʻlov",
    "cart.payment_val": "joyida · qulay tarzda",
    "cart.positions_n": "{n} ta",
    "request.hdr": "Ariza",
    "request.title": "Qayerga qoʻngʻiroq qilaylik?",
    "request.lede": "Sana, toʻlov va tafsilotlarni usta suhbatda aniqlaydi — boshqa hech narsa toʻldirish shart emas.",
    "request.f_phone": "Telefon",
    "request.from_tg": "Telegramingizdan",
    "request.plus_more": "{first} va yana {n}",
    "request.add_details": "Sana va izoh qoʻshish",
    "request.no_pay": "Hozir hech narsa toʻlamaysiz",
    "showcase.title": "Bizning ishlar",
    "success.title": "№{n} ariza qabul qilindi",
